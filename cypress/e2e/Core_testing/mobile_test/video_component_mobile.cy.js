...
it.only('user verify video is collapsing' , function() {
  cy.visit('https://damndelicious.net/2022/08/05/weeknight-lemon-chicken-breasts/')
  const ad = new ads();
...
it('user verify video location' , function() {
  ...
  cy.get("div[class='adthrive-player-position adthrive-player-without-wrapper-text adthrive-collapse-mobile adthrive-collapse-medium adthrive-collapse-bottom-right']")
